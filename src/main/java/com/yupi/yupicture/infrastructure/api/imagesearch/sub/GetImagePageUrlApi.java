...
public class GetImagePageUrlApi {
    ...
    public static String getImagePageUrl(String imageUrl) {
        ...
        try {
            ...
            HttpResponse response = HttpRequest.post(url)
                    ...
                    .timeout(50000)
                    .execute();
            log.info("百度接口响应状态: {}, body: {}", response.getStatus(), response.body());
            // 判断响应状态
    ...
    public static void main(String[] args) {
        // 测试以图搜图功能
        String imageUrl = "https://pic1.zhimg.com/v2-37763ef43f018ce09ed44de0ef1afb46_xld.jpg";
